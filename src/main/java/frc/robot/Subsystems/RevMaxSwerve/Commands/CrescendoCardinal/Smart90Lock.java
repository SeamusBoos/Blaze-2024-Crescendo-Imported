...
public class Smart90Lock extends Command {
    ...
    public Smart90Lock(DriveSubsystemSwerve subsystem){
    ...
    public void initialize() {
        ...
        if(-45<=heading180 && heading180<=45){
            target = 0;
        } else if(heading180 < -45 && heading180 >=-135){
            target = -90;
        } else if(heading180 > 45 && heading180 <=135){
            target = 90;
        } else if(heading360 > 135 && heading360 < 225){
            target = 180;
        }
