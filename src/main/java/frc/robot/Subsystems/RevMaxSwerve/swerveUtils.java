...
/**
 * Helper functions for the swerve modules and swerve drive.
 */
public class swerveUtils {
  ...
  public static double stepTowards(double current, double target, double stepsize) {
    ...
    /**
     * Steps a value (angle) towards a target (angle) taking the shortest path with a 
     * specified step size.
     *
     * @param _current The current or starting angle (in radians). 
     * Can lie outside the 0 to 2*PI range.
     * @param _target The target angle (in radians) the algorithm will step towards.
     * Can lie outside the 0 to 2*PI range.
